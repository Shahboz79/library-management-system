...
<style>
    body {
        background: url("images/utgan-kunlar.png");
    }
    .container {width: 80%;margin: auto;top: 50px;position: relative;
    }
    .flexnav,.flexnav ul{
...
<div class="container">
    ...
    <ul class="flexnav" data-breakpoint="800">
        <li><a href="navbar.jsp">LIBRARY</a></li>
        <li><a href="/users">USERS</a></li>
        <li>
            <a href="/books">BOOKS</a>
        </li>
        <li><a href="issued_returned.jsp">RETURNED/ISSUED</a></li>
